...
public class CamelCaseConfig implements PersistentStateComponent<CamelCaseConfig> {
    ...
    @Nullable
    public static CamelCaseConfig getInstance() {
        return ApplicationManager.getApplication().getService(CamelCaseConfig.class);
    }
